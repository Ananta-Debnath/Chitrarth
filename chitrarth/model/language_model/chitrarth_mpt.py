...
class ChitrarthModel(ChitrarthMetaModel, MPTModel):
    config_class = ChitrarthConfig

    def __init__(self, config: MPTConfig):
        config.hidden_size = config.d_model
        super(ChitrarthModel, self).__init__(config)
    
    def embed_tokens(self, x):
        return self.wte(x)


class ChitrarthForCausalLM(MPTForCausalLM, ChitrarthMetaForCausalLM):
    config_class = ChitrarthConfig
    ...
    def __init__(self, config):
        ...
        self.transformer = ChitrarthModel(config)
...
AutoConfig.register("chitrarth", ChitrarthConfig)
AutoModelForCausalLM.register(ChitrarthConfig, ChitrarthForCausalLM)
